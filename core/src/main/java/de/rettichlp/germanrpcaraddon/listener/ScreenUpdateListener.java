...
public class ScreenUpdateListener {
     ...
     *
     * <p>This method checks if the container ID has changed since the last render.
     * If a change is detected, it updates the stored container ID and fires a {@link ScreenUpdateEvent} with the new container ID.
     *
